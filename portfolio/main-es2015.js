...
/* harmony import */ var _sudoku_sudoku_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./sudoku/sudoku.component */ "./src/app/sudoku/sudoku.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _sudoku_sudoku_component__WEBPACK_IMPORTED_MODULE_12__["SudokuComponent"]
        ],
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([
                ...
                { path: "sudoku", component: _sudoku_sudoku_component__WEBPACK_IMPORTED_MODULE_12__["SudokuComponent"] },
                ...
                { path: "work", component: _work_work_component__WEBPACK_IMPORTED_MODULE_11__["WorkComponent"] },
...
let SudokuComponent = class SudokuComponent {
    ...
    //* -------------------------------------------- CHECK BOARD
    formatBoard() {
        let boxes = this.sudoku.boxes;
        let rows = this.sudoku.rows;
        let cols = this.sudoku.cols;
        let rand = this.getRandom(1, 9);
    ...
    numberClicked(myNum) {
        ...
        if (myNum.selected == false)
            this.selectedNum = 0;
        console.log(this.selectedNum);
        // ----------------------
        this.sudoku.boxes.forEach(box => {
            box.forEach(cell => {
                if (cell.value != this.selectedNum || this.selectedNum == 0)
    ...
    cellClicked(myCell) {
        ...
        this.sudoku.boxes.forEach(box => {
            box.forEach(cell => {
                if (this.selectedNum != 0 && cell.value == this.selectedNum && !cell.clicked)
                    cell.highlighted = true;
                if (cell.value == myCell.value)
                    cell.highlighted == true;
            });
        });
    }
...
SudokuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-sudoku',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./sudoku.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sudoku/sudoku.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./sudoku.component.scss */ "./src/app/sudoku/sudoku.component.scss")).default]
    })
], SudokuComponent);
...
module.exports = __webpack_require__(/*! D:\_backup\_nsccportfolio\portfolio\src\main.ts */"./src/main.ts");
